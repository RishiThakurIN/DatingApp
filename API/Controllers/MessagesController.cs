...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        public async Task<ActionResult> DeleteMessage(int id)
        {
            ...
            if (message.SenderUername != username && message.RecipientUsername != username)
                return Unauthorized();

            if (message.SenderUername == username) message.SenderDeleted = true;
